...
if Code.ensure_loaded?(Igniter) do
  defmodule Mix.Tasks.Soot.Install do
    ...
    # resource generated by `ash_authentication.install`, then flips
    # the magic-link strategy's `registration_enabled?` to `false`.
    # Together these turn the User into an admin-only actor whose
    # tenant scope is read by the per-resource policies in
    # soot_core / ash_pki / soot_telemetry / soot_segments / soot_contracts.
